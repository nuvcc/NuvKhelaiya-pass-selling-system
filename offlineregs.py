...
class Earlybird:
    def __init__(self,root):
        ...
        txt_name = Entry(manage_frame,textvariable=self.name_var,font =("nunito",10,"bold"),bd=2)
        ...
        txt_phonenumber = Entry(manage_frame,textvariable=self.phonenumber_var, font =("nunito",10,"bold"),bd=2)
        ...
        txt_enrollment = Entry(manage_frame,textvariable=self.enrollment_var, font =("nunito",10,"bold"),bd=2)
    ...
    def adddata(self):
        ...
        valueinc = int(len(self.l1))
        self.globalincvalue = (valueinc + 1)
        self.uid_var.set(self.globalincvalue)
    ...
    def updatedata(self):
        ...
        phone = self.phonenumber_var.get()
        enrollment = self.enrollment_var.get()
        updatepayment = self.payment_var.get()

        self.wk1.append_table(values=[self.globalincvalue,name,phone,enrollment,updatepayment])
        # pygsheets.Row(rownum,"-",self.wk1).set_value(name,phone,enrollment,updatepayment)  
        # self.searchdata()
        self.adddata()
        self.name_var.set("")
        self.phonenumber_var.set("")
